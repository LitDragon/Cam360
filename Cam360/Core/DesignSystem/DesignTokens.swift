...
enum AppRadius {
    ...
    static let recordingPreviewPill: CGFloat = 10
...
enum AppLayout {
    ...
    static let recordingPreviewHeight: CGFloat = 214
    static let recordingPreviewPillDotSize: CGFloat = 6
    static let recordingPreviewPillVerticalPadding: CGFloat = 7
    static let recordingPreviewLaneDash: [CGFloat] = [14, 18]
    static let recordingPreviewRoadEdgeWidth: CGFloat = 4
    static let recordingPreviewLaneDividerWidth: CGFloat = 4
    static let recordingPreviewLaneHighlightWidth: CGFloat = 2
    static let recordingPreviewLaneMarkerWidth: CGFloat = 3
    static let recordingDrawerWidth: CGFloat = 300
...
enum AppShadow {
    static let recordingPreview = ShadowStyle(
...
enum AppArtworkPalette {
    static let recordingPreviewBackground = [
        Color(red: 0.15, green: 0.56, blue: 0.9),
        Color(red: 0.14, green: 0.43, blue: 0.82),
        Color(red: 0.1, green: 0.23, blue: 0.44)
    ]
    static let recordingPreviewLeftTerrain = [
        Color(red: 0.77, green: 0.62, blue: 0.35),
        Color(red: 0.45, green: 0.33, blue: 0.2)
    ]
    static let recordingPreviewRightTerrain = [
        Color(red: 0.07, green: 0.48, blue: 0.76),
        Color(red: 0.03, green: 0.28, blue: 0.52)
    ]
    static let recordingPreviewRoad = [
        Color(red: 0.42, green: 0.43, blue: 0.45),
        Color(red: 0.2, green: 0.21, blue: 0.23)
    ]
    static let recordingPreviewRoadEdge = Color(red: 0.24, green: 0.23, blue: 0.19)
    static let recordingPreviewLaneMarker = Color(red: 0.93, green: 0.8, blue: 0.16)
    static let recordingPreviewOverlayStroke = Color.white.opacity(0.08)
    static let recordingPreviewTimestamp = Color.white.opacity(0.84)
    static let recordingPreviewLaneDivider = Color.white.opacity(0.92)
    static let recordingPreviewLaneHighlight = Color.white.opacity(0.86)
    static let recordingPreviewPillBackground = Color.black.opacity(0.42)
    static let recordingEventVehicle = [
        Color(red: 0.72, green: 0.63, blue: 0.59),
        Color(red: 0.37, green: 0.34, blue: 0.36)
    ]
    static let recordingEventLandscape = [
        Color(red: 0.42, green: 0.75, blue: 0.82),
        Color(red: 0.23, green: 0.45, blue: 0.28)
    ]
    static let recordingEventNightDrive = [
        Color(red: 0.24, green: 0.39, blue: 0.57),
        Color(red: 0.08, green: 0.11, blue: 0.2)
    ]
    static let recordingEventParking = [
        Color(red: 0.53, green: 0.75, blue: 0.48),
        Color(red: 0.21, green: 0.43, blue: 0.24)
    ]
    static let recordingDeviceBody = [
        Color(red: 0.54, green: 0.58, blue: 0.66),
        Color(red: 0.34, green: 0.37, blue: 0.45)
    ]
    static let recordingFeatureBackground = [
        Color(red: 0.97, green: 0.98, blue: 1.0),
        Color(red: 0.93, green: 0.95, blue: 1.0)
    ]
    static let recordingFeatureCameraBody = [
        Color(red: 0.2, green: 0.23, blue: 0.28),
        Color(red: 0.08, green: 0.09, blue: 0.13)
    ]
    static let recordingFeatureCameraScreen = [
        Color(red: 0.34, green: 0.47, blue: 0.58),
        Color(red: 0.15, green: 0.17, blue: 0.21)
    ]
    static let recordingFeaturePhoneBody = Color(red: 0.97, green: 0.97, blue: 1.0)
